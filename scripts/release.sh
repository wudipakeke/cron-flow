...
echo ""
echo -e "${CYAN}╔══════════════════════════════════════════════╗${NC}"
echo -e "${CYAN}║     🚀 CronFlow Release Process              ║${NC}"
echo -e "${CYAN}╚══════════════════════════════════════════════╝${NC}"
echo ""

# ── Step 1: Lint Check ──
echo -e "${YELLOW}[1/3] Running ESLint check...${NC}"
...
if pnpm lint:check; then
  ...
  echo ""
  echo -e "  ${RED}❌ ESLint found errors, release aborted${NC}"
